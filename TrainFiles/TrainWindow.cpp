...
//		splineBrowser->add("Cubic B Splice");
		splineBrowser->callback((Fl_Callback*)curveTypeCB, this);
		...
		trackBrowser->add("Double");
//		trackBrowser->add("Cubic B Splice");
		trackBrowser->callback((Fl_Callback*)trackTypeCB, this);
		trackBrowser->select(1);
		pty+=110;

		Fl_Button* fogButton = new Fl_Button(605,pty,60,20,"Fog");
		togglify(fogButton);
		fogButton->callback((Fl_Callback*)fogButtonCB, this);
